...
import type { PolicyId, PolicyAction, TimeWindow, PaymentProtocol } from '@spendrail/core';
...
export function registerPolicyTool(server: McpServer, stack: SpendRailStack): void {
  server.tool(
    'manage_policy',
