 ...
 * This is the core data structure that flows through all SpendRail pillars.
 */
export interface AgentTransaction {
  /** Unique transaction identifier (format: sr_<hex_timestamp>_<random>) */
...
/**
 * AgentProfile represents a registered agent in the SpendRail system.
...
export interface AgentProfile {
  ...
  trustScore: number;
  /** Total amount spent through SpendRail */
  totalSpent: number;
