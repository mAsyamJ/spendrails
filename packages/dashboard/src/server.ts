// =============================================================================
// @spendrail/dashboard — JSON-over-HTTP dashboard for agents
...
import type { EventBus, AgentId, DisputeStatus } from '@spendrail/core';
import type { PolicyEngine } from '@spendrail/control';
import type { SpendTracker, SpendAnalytics } from '@spendrail/observe';
import type { TransactionProvenance, DisputeManager } from '@spendrail/protect';
import type { AgentRegistry } from '@spendrail/a2a';
...
<html><head><meta charset="UTF-8"><title>SpendRail Dashboard</title>
<style>
