// =============================================================================
// @spendrail/wallet — Type Definitions
 ...
 * SpendRail never touches private keys — it delegates signing to the adapter
...
// ---------------------------------------------------------------------------
// SpendRailWallet Configuration
// ---------------------------------------------------------------------------

/**
 * Configuration for the SpendRailWallet orchestrator.
 */
export interface SpendRailWalletConfig {
  /** Logger instance */
 ...
 * This is the public-facing input to SpendRailWallet.executePayment().
 */
