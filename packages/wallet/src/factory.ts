// =============================================================================
// createWallet() — The "Stripe-like" one-liner for SpendRail
//
...
import { SpendRailWallet } from './spendrail-wallet.js';
...
/**
 * Create a fully-wired SpendRailWallet in one call.
 *
 ...
 * @example
 * ```ts
 * import { createWallet, presets } from '@spendrail/wallet';
 *
 ...
 * ```
 */
export function createWallet(options: CreateWalletOptions): SpendRailWallet {
  // 1. Resolve adapter
