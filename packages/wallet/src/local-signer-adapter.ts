...
//
// This is the "self-custody" option — you own the keys, SpendRail owns the rules.
// =============================================================================

import { createCipheriv, createDecipheriv, randomBytes, scryptSync, createHash } from 'crypto';
import { readFileSync, writeFileSync, existsSync } from 'fs';
import type { AgentTransaction, Logger } from '@spendrail/core';
import type {
  WalletAdapter,
  WalletBalance,
  TransactionReceipt,
 ...
 * - SpendRail PolicyEngine gates all signAndSend calls
 *
 * @example
 * ```ts
