// =============================================================================
// SpendRail Quickstart — All 4 pillars in 5 minutes
// =============================================================================

import type { AgentId, PolicyId, ServiceId } from '@spendrail/core';
import { createTransaction } from '@spendrail/core';

// Observe
import { SpendTracker, SpendAnalytics, SpendAlerts } from '@spendrail/observe';
...
// Sandbox (Test)
import { MockX402, MockACP, SCENARIO_OVERSPEND } from '@spendrail/sandbox';
...
console.log('\n--- Summary ---\n');
console.log('  SpendRail gives you full control over AI agent payments:');
