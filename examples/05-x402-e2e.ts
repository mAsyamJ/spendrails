#!/usr/bin/env npx tsx
// =============================================================================
// SpendRail x402 E2E Example — The Full Payment Flow
//
// Shows the complete x402 payment lifecycle with SpendRail controls:
//   Policy evaluation → Circuit breaker → Facilitator → Spend tracking → Alerts
//
// Run: npx tsx examples/05-x402-e2e.ts
// =============================================================================

import { createTransaction, type AgentId, type PolicyId } from '@spendrail/core';
...
async function main() {
  ...
  console.log('  SpendRail x402 E2E Demo');
